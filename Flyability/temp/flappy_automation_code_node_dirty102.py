...
## Control settings ## ============================================================= #
T_STOPX = 1 # desired time to stop in x [s]
T_STOPY = 0.12 # desired time to stop in y [s]
MAX_VELX = 3.7#T_STOPX*MAX_ACCX # max speed in x to stop in T_STOPX [m/s] 
...
def velCallback(msg):
	...
	#accx = -MAX_ACCX #-velx/T_STOPX # can't go negative
        velx_d = -MAX_VELX#MAX_VELX*distance_wall 
    # look for hole in Y
    vely_d = 0
    ...
    KpX = 40
    #KdX = 1
    KpY =50 # peut monter bcp plus haut
    KdY = 0.
